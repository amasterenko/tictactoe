...
public class ConsoleGameInitHHTest {
    ...
    public void whenInitBoardPlayer1FirstWithXPlayer2SecondWithO() {
        ...
        ConsoleGameInit init = new ConsoleGameInitHH(new Scanner(answers), out);
    ...
    @Test
    public void whenInitBoardPlayer1SecondWithOPlayer2FirstWithO() {
        int size = 5;
        int boardMinSize = 1;
        int boardMaxSize = 10;
        String player1Name = "player1";
        ...
        char x = 'X';
        char o = 'O';
        String answers = size + ln + player1Name  + ln + "2" + ln + "2" + ln + player2Name + ln;
        ConsoleGameInit init = new ConsoleGameInitHH(new Scanner(answers), out);
        init.init(boardMinSize, boardMaxSize);
        assertEquals(size, init.getBoard().getState().length);
